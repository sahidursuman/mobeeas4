...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { company: @enquiry.company, email: @enquiry.email, enquiry_type: @enquiry.enquiry_type, message: @enquiry.message, name: @enquiry.name, phone: @enquiry.phone }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { company: @enquiry.company, email: @enquiry.email, enquiry_type: @enquiry.enquiry_type, message: @enquiry.message, name: @enquiry.name, phone: @enquiry.phone }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
