...
EngagementTokenPack.create!(name: 'One token', price_ex_gst: 63, number_of_tokens: 1)
EngagementTokenPack.create!(name: 'Two token', price_ex_gst: 120, number_of_tokens: 2)
EngagementTokenPack.create!(name: 'Five token', price_ex_gst: 275, number_of_tokens: 5)
...
SubscriptionPack.create!(name: 'organisation', price_ex_gst: 220.00)
SubscriptionPack.create!(name: 'independent', price_ex_gst: 55.00)
SubscriptionPack.create!(name: 'candidate', price_ex_gst: 22.00)
