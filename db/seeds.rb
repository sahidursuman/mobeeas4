...
user9.add_role :host
host_independent1 = OrgUserProfile.create!(user_id: user9.id, first_name: 'Helen', last_name: 'Hunt', phone: '0299998888', position: 'parent', suburb: 'Redfern', state: 'NSW', postcode: '2016', country: 'AU', agency: 'independent host')

user10 = User.create!(email: 'host-independent2@mobeeas.com', password: '12345678')
user10.add_role :host
host_independent2 = OrgUserProfile.create!(user_id: user10.id, first_name: 'Hugh', last_name: 'Hewson', phone: '0299998888', position: 'parent', suburb: 'Mascot', state: 'NSW', postcode: '2020', country: 'AU', agency: 'independent host')
...
# host_org1 = OrgUserProfile.create!(user_id: user11.id, first_name: 'Harry', last_name: 'Hart', phone: '0299998888', position: 'SAM', suburb: 'Wahroonga', state: 'NSW', postcode: '2076', country: 'AU', agency: 'organisation host')
...
# Do not create the host org profile, it has to be created upon an existing organisation, must enter it manually
# host_org2 = OrgUserProfile.create!(user_id: user12.id, first_name: 'Helen', last_name: 'Hamden', phone: '0299998888', position: 'SAM', suburb: 'Lindfield', state: 'NSW', postcode: '2070', country: 'AU', agency: 'organisation host')
